...
update "pensjon-erUngUfor-tjenestespesifikasjon" "http://maven.adeo.no/nexus/service/local/repositories/m2internal/content/no/nav/esb/ekstern/pensjon/ekstern-pensjon-tjeneste-erUngUfor/1.0.0/ekstern-pensjon-tjeneste-erUngUfor-1.0.0-wsexports.zip"
